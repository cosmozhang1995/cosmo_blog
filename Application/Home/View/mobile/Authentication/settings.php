...
<div class="login-form">
	<form method="post" id="login-form">
		...
		<div class="input-group">
			<label>用户名</label>
			<div class="input-container"><span>{$user.name}</span></div>
		</div>
		<div id="change-password-form" style="display:none;">
			<div class="input-group">
				<label>当前密码</label>
				<div class="input-container"><input type="password" id="oldpassword" placeholder="请输入当前的密码" /></div>
			</div>
			<div class="input-group">
				<label>新密码</label>
				<div class="input-container"><input type="password" id="password" placeholder="6-16个字符" /></div>
			</div>
			<div class="input-group">
				<label>确认密码</label>
				<div class="input-container"><input type="password" id="password-check" placeholder="再次输入新密码" /></div>
			</div>
		</div>
		<div class="input-group">
			<label id="change-passwd-title">密码</label>
			<div class="input-container"><span><a href="javascript:void(0);" id="change-passwd-button" onclick="toggleChangePasswd();">修改密码</a></span></div>
		</div>
		<div class="input-group">
			<label>昵称</label>
			<div class="input-container"><input type="text" id="alias" value="{$user.alias}" placeholder="昵称" /></div>
		</div>
		<div class="input-group">
			<label>邮箱</label>
			<div class="input-container"><input type="email" id="email" value="{$user.email}" placeholder="E-mail 地址" /></div>
		</div>
