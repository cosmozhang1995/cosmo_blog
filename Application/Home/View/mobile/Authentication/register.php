...
<div class="login-form">
	<form method="post" id="login-form">
		...
		<div class="input-group">
			<label>用户名</label>
			<div class="input-container"><input type="text" id="username" value="{$post.username}" placeholder="4-16个字母、数字或下划线，以字母开头" /></div>
		</div>
		<div class="input-group">
			<label>密码</label>
		...
		<div class="input-group">
			<label>确认密码</label>
			<div class="input-container"><input type="password" id="password-check" placeholder="再次输入密码" /></div>
		</div>
		<div class="input-group">
			<label>昵称</label>
			<div class="input-container"><input type="text" id="alias" value="{$post.alias}" placeholder="昵称" /></div>
		</div>
		<div class="input-group">
			<label>邮箱</label>
			<div class="input-container"><input type="email" id="email" value="{$post.email}" placeholder="E-mail 地址" /></div>
		</div>
		...
		<div class="input-group" style="width:100%; height:auto; text-align:center;">
