...
.article-item-container:first-child .article-item {
...
<if condition="$page neq $pt">
.article-item-container:last-child .article-item {
	...
	<div class="article-list">
		<volist name='list' id='vo'>
			<div class="article-item-container">
				<a class="article-item button" href="{:U('/article/'.$vo['id'])}" >
					<span class="article-title">{$vo.title}</span>
					<span class="article-time">{$vo.create_time|translateDate}</span>
					<span class="label label-info">{$vo.tag|translateTag="Article",###}</span>
				</a>
